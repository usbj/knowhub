...
export interface MockBlog {
  ...
  collects: number
  publishTime: string
  /** 状态：DRAFT/PUBLISHED/PENDING_REVIEW/REJECTED/REVOKED */
...
export const blogs: MockBlog[] = [
  ...
  },
  {
    ...
    cover: 'linear-gradient(135deg,#f59e0b,#fde68a)',
    author: '何川',
    authorId: 6,
...
/** 按 id 取详情 */
export const getBlogById = (id: number): MockBlog | undefined => blogs.find((b) => b.id === id)
