...
import com.rookie.common.until.ServletUntil;
...
//        System.out.println(1);
        log.error("系统发生了一个业务错误，请求路径:{} >>> {}",ServletUntil.getRequestCompleteURL(),e.getMessage());
        return Result.error(500,e.getMessage());
    }

    @ExceptionHandler(Exception.class)
    public Result exceptionHandle(Exception e){
        log.error("系统发生了一个位置错误，请求路径:{} >>> {}",ServletUntil.getRequestCompleteURL(),e.getMessage());
