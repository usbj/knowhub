 ...
 * - 调用目标（beanName + methodName）限定 task.bean-package-prefixes 配置项所列包
 *   （默认 com.rookie.system.task，knowhub 扩展 com.knowhub.task），表单 placeholder 明确提示。
 */
...
export const createJobSchema = (
  ...
  beanName: {
    label: 'Bean 名称',
    inputType: 'text',
    placeholder: '如 blogReviewReconcileTask（限 com.rookie.system.task / com.knowhub.task 包）',
    tableVisible: true,
    formVisible: true,
    tableOrder: 3,
    formOrder: 2,
